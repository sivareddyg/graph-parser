...
public class CcgAutoLexiconTest {
  ...
  public void testMapSynCatToIndexSynCatFromFile() throws IOException {
    CcgAutoLexicon lexicon = new CcgAutoLexicon("./tools/candc_nbest/models/parser/cats/markedup",
        "./data/unary_rules.txt", "./data/binary_rules.txt", "./data/lexicon_specialCases.txt");
    String indexCat = lexicon.getIndexedSyntacticCategory("((S[adj]\\NP)/(S[to]\\NP))/PP");
