...
public class CcgParseTreeTest {
  ...
  @Test
  public void testParseFromString() throws IOException, FunnyCombinatorException,
      BadParseException {
    ...
    sent = "Miyagi is a pulp culture icon who was brilliantly played by Pat_Morita .";
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] rp 0 2> (<T S[dcl] ba 1 2> (<T NP lex 0 1> (<L N Miyagi Miyagi NNP I-PER I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP is be VBZ O I-VP (S[dcl]\\NP)/NP>) (<T NP ba 0 2> (<T NP[nb] fa 1 2> (<L NP[nb]/N a a DT O I-NP NP[nb]/N>) (<T N fa 1 2> (<L N/N pulp pulp NN O I-NP N/N>) (<T N fa 1 2> (<L N/N culture culture NN O I-NP N/N>) (<L N icon icon NN O I-NP N>)))) (<T NP\\NP fa 0 2> (<L (NP\\NP)/(S[dcl]\\NP) who who WP O B-NP (NP\\NP)/(S[dcl]\\NP)>) (<T S[dcl]\\NP fa 0 2> (<T (S[dcl]\\NP)/(S[pss]\\NP) bx 0 2> (<L (S[dcl]\\NP)/(S[pss]\\NP) was be VBD O I-VP (S[dcl]\\NP)/(S[pss]\\NP)>) (<L (S\\NP)\\(S\\NP) brilliantly brilliantly RB O I-VP (S[X]\\NP)\\(S[X]\\NP)>)) (<T S[pss]\\NP ba 0 2> (<L S[pss]\\NP played play VBN O I-VP S[pss]\\NP>) (<T (S\\NP)\\(S\\NP) fa 0 2> (<L ((S\\NP)\\(S\\NP))/NP by by IN O I-PP ((S[X]\\NP)\\(S[X]\\NP))/NP>) (<T NP lex 0 1> (<L N Pat_Morita Pat_Morita NNP I-LOC I-NP N>))))))))) (<L . . . . O O .>))");
    System.out.println(ccgParseTrees);
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP[nb] fa 1 2> (<L NP[nb]/N My my PRP$ O I-NP NP[nb]/N>) (<L N name name NN O I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP is be VBZ O I-VP (S[dcl]\\NP)/NP>) (<T NP lex 0 1> (<L N Siva Siva NNP I-PER I-NP N>))))");
    System.out.println(ccgParseTrees);
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP[nb] fa 1 2> (<T NP[nb]/N ba 1 2> (<T NP lex 0 1> (<L N Obama Obama NNP I-LOC I-NP N>)) (<L (NP[nb]/N)\\NP 's 's POS O B-NP (NP[nb]/N)\\NP>)) (<L N birthplace birthplace NN O I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP is be VBZ O I-VP (S[dcl]\\NP)/NP>) (<T NP lex 0 1> (<L N Hawaii Hawaii NNP I-LOC I-NP N>))))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
...
sent = "Obama 's place of birth is Kenya .";
    ...
    sent = "The cooperation between Pitt and John in Casablanca yielded millions";
    ccgParseTrees =
        ccgParser.parseFromString(
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP lex 0 1> (<L N India India NNP I-LOC I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/(S[b]\\NP) could could MD O I-VP (S[dcl]\\NP)/(S[b]\\NP)>) (<T S[b]\\NP fa 0 2> (<L (S[b]\\NP)/NP win win VB O I-VP (S[b]\\NP)/NP>) (<T NP[nb] fa 1 2> (<L NP[nb]/N the the DT O I-NP NP[nb]/N>) (<L N match match NN O I-NP N>)))))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP lex 0 1> (<L N Siva Siva NNP I-PER I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP is be VBZ O I-VP (S[dcl]\\NP)/NP>) (<T NP[nb] fa 1 2> (<L NP[nb]/N my my PRP$ O I-NP NP[nb]/N>) (<L N name name NN O I-NP N>))))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
    ...
    sent = "The Bavarian_Illuminati , a rationalist secret society , was founded by Adam_Weishaupt";
    ccgParseTrees =
        ccgParser.parseFromString(
    ...
    sent = "HSBC has eight branches throughout the Emirates , of which three are in Dubai";
    ccgParseTrees =
        ccgParser.parseFromString(
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP lex 0 1> (<L N Adobe Adobe NNP I-ORG I-NP N>)) (<T S[dcl]\\NP fa 1 2> (<L (S\\NP)/(S\\NP) recently recently RB O I-ADVP (S[X]\\NP)/(S[X]\\NP)>) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP bought buy VBD O I-VP (S[dcl]\\NP)/NP>) (<T NP lex 0 1> (<L N Macromedia Macromedia NNP I-LOC I-NP N>)))))");
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T S[dcl] ba 1 2> (<T NP lex 0 1> (<L N Cameron Cameron NNP I-PER I-NP N>)) (<T S[dcl]\\NP fa 0 2> (<L (S[dcl]\\NP)/NP directed direct VBD O I-VP (S[dcl]\\NP)/NP>) (<T NP[nb] fa 1 2> (<L NP[nb]/N the the DT O I-NP NP[nb]/N>) (<T N fa 1 2> (<L N/N movie movie JJ O I-NP N/N>) (<L N Titanic Titanic NNP O I-NP N>)))))");
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T N ba 0 2> (<L N director director NN O I-NP N>) (<T N[conj] conj 0 2> (<L conj and and CC O I-NP conj>) (<L N producer producer NN O I-NP N>)))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T NP ba 0 2> (<T NP lex 0 1> (<L N state state NN O I-NP N>)) (<T NP\\NP lex 0 1> (<T S[ng]\\NP fa 1 2> (<L (S\\NP)/(S\\NP) not not RB O I-VP (S[X]\\NP)/(S[X]\\NP)>) (<T S[ng]\\NP fa 0 2> (<L (S[ng]\\NP)/NP bordering border VBG O I-VP (S[ng]\\NP)/NP>) (<T NP lex 0 1> (<L N Texas Texas NNP I-LOC I-NP N>))))))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
    ...
    ccgParseTrees =
        ccgParser.parseFromString(
            "(<T NP ba 0 2> (<T NP lex 0 1> (<L N states state NNS O I-NP N>)) (<T NP\\NP lex 0 1> (<T S[pss]\\NP ba 0 2> (<L S[pss]\\NP bordered border VBN O I-VP S[pss]\\NP>) (<T (S\\NP)\\(S\\NP) fa 0 2> (<L ((S\\NP)\\(S\\NP))/NP by by IN O I-PP ((S[X]\\NP)\\(S[X]\\NP))/NP>) (<T NP[nb] fa 1 2> (<L NP[nb]/N no no DT O I-NP NP[nb]/N>) (<L N states state NNS O I-NP N>))))))");
    relations = ccgParseTrees.get(0).getLexicalisedSemanticPredicates();
    System.out.println(sent);
    System.out.println(relations);
    System.out.println();
