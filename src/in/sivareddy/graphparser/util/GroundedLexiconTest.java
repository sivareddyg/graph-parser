...
public class GroundedLexiconTest {
  ...
  public void testGroundedLexicon() throws IOException {
    ...
    System.out.println("urel tf-idf: " + lexicon.getUngroundedRelationScore(urel));
    ...
    System.out.println("Grel freq: " + " " + lexicon.getGroundedRelationFreq(grel));
    System.out.println("prob urel grel: " + grel.getWeight());
    System.out.println("prob urel grel: " + lexicon.getUrelGrelProb(urel, grel));

    System.out.println(
        "urel grel part prob : " + lexicon.getUrelPartGrelPartProb(urel.getLeft(), grel.getLeft()));
    ...
    System.out.println("Ungrounded tf-idf: " + lexicon.getUngroundedTypeScore(utype));
    System.out.println("Grounded Types: " + gtypes);
    EntityType gtype = gtypes.get(2);
    System.out.println("Target Grounded Type: " + gtype);
    System.out.println(
        "prob utype gtype: " + lexicon.getUtypeGtypeProb(utype.getType(), gtype.getType()));
