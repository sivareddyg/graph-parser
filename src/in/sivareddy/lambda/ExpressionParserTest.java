...
public class ExpressionParserTest extends TestCase {
  ...
  public void testParse() {
    Expression result = ExpressionParser.parseSingleExpression("(relation (/m/abc x) (/m/bcd y) /m/cde)");
    
    assertTrue(result instanceof ApplicationExpression);
    ApplicationExpression application = (ApplicationExpression) result;
    assertEquals("relation", ((ConstantExpression) application.getFunction()).getName());
