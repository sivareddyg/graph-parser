...
public class NerJsonInputDataCaseless {

	public static void main(String[] args) throws IOException {

		String serializedClassifier = "./tools/stanford-ner-2012-11-11/classifiers/english.muc.7class.caseless.distsim.crf.ser.gz";
