...
More details about this code on http://sivareddy.in/load-freebase-dump-into-virtuoso-sparql-sql 

Converts Freebase to standard RDF Turle format.

usage: python fix_freeebase.py < input_dump > output_dump

Best is to use compressed files itself.

zcat input_dump.gz | python fix_freebase.py | gzip > output_dump.gz
