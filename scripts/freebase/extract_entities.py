...
# extract entities by using the relations that connect domain's main/mediator types with any other entity types.
# To do this, process only the relations with which main/mediator types appear.
def extract_entities(schema_dir, out_dir):
    ...
    for domain_name in entities:
        out_file = open(os.path.join(out_dir, domain_name + "_entities_stats.txt"), "w")
